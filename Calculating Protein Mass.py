...
DNA = open("C:/Users/Tharinda Karawita/Downloads/rosalind_prtm.txt", "r").read().rstrip()
monoisotopic_mass_table ="""A   71.03711
                            ...
                            W   186.07931
                            Y   163.06333"""
table = dict(zip(monoisotopic_mass_table.split()[::2],[float(i) for i in monoisotopic_mass_table.split()[1::2]]))
x = 0
for i in DNA:
    x += table.get(i)
print(round(x,3))